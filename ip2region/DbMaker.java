...
//            BufferedReader greader = new BufferedReader(new FileReader(globalRegionFile));
            BufferedReader greader = new BufferedReader(new InputStreamReader(new FileInputStream(globalRegionFile), "UTF-8"));
            String gline = null;
        ...
        String copyright = "Created by analyzer at " + dateFormat.format(cal.getTime());
